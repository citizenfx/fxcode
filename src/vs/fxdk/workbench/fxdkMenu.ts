...
export class FxDKActivityActionViewItem extends MenuActivityActionViewItem {
	constructor(
		...
		super(FxDKMenu, action, contextMenuActionsProvider, false, colors, activityHoverOptions, themeService, hoverService, menuService, contextMenuService, contextKeyService, configurationService, environmentService, keybindingService);
	}
}
