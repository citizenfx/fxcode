...
export class RemoteAgentService extends AbstractRemoteAgentService implements IRemoteAgentService {
	private fxdkConnection: IRemoteAgentConnection | null;
	...
	constructor(
		...
		this.fxdkConnection = this._register(new RemoteAgentConnection(window.location.host, productService.commit, undefined, this.socketFactory, remoteAuthorityResolverService, signService, logService));
	}

	override getConnection() {
		return this.fxdkConnection;
	}
}
