	...
	private async initializeServices(args: NativeParsedArgs): Promise<void> {
		const productService: IProductService = {
			...
			'extensionsGallery': {
				...
				'publisherUrl': 'https://marketplace.visualstudio.com/publishers/{publisher}',
				'nlsBaseUrl': '', // TODO: obviously wrong.
			},
		};
		...
		*/
		...
		this.ipc.registerChannel('logger', new LogLevelChannel(logService, loggerService));
		...
		*/
		...
		await new Promise((resolve) => {
			...
			instantiationService.invokeFunction((accessor) => {
				...
				this.services.set(ILanguagePackService, new SyncDescriptor(NativeLanguagePackService));
