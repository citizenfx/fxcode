...
export async function doStart(): Promise<IDisposable> {
	...
	const logLevel: string | undefined = undefined;
	...
	subscriptions.add(create(document.body, {
		...
		//webWorkerExtensionHostIframeSrc: webWorkerExtensionEndpoint.href, // TODO: this has been moved to somewhere else
		...
		productConfiguration: {
			...
			'extensionsGallery': {
				...
				'publisherUrl': 'https://marketplace.visualstudio.com/publishers', // TODO: fixme, this URL is obviously wrong
				'resourceUrlTemplate': 'https://{publisher}.vscode-unpkg.net/{publisher}/{name}/{version}/{path}',
				'controlUrl': 'https://az764295.vo.msecnd.net/extensions/marketplace.json',
				'recommendationsUrl': 'https://az764295.vo.msecnd.net/extensions/workspaceRecommendations.json.gz',
				'nlsBaseUrl': 'https://az764295.vo.msecnd.net/extensions/i18n', // TODO: fixme, this URL is obviously wrong
			},
		...
		settingsSyncOptions: {
			enabled: false,
			enablementHandler: (enablement: any) => {
				// TODO
			}
		},
	}));
